# Prompt - Validate the Idea

**What it does:** produces a sharp problem statement, surfaces the riskiest assumption, and designs a cheap, fast validation plan with a clear pass/fail bar.
