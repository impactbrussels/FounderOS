...
- [ ] New skill (claims a roadmap slot)
- [ ] Improves an existing skill / flow / loop / agent
- [ ] Docs / governance
- [ ] Fix
...
- [ ] **Roadmap updated** - `ROADMAP.md` status changed (e.g. 🟢 → ✅) if applicable.
...
<!-- Anything you want a reviewer to look at closely, or open questions. -->
