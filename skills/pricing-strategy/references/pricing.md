...
| Basis | What it answers | Use it for | Trap |
|-------|-----------------|-----------|------|
...
## Value-anchor worksheet

> For **[ICP]**, solving **[PROBLEM]** is worth **[$ or hours]** because it **[saves/earns what,
...
| Model | How you charge | Fit signal | Watch out for |
|-------|----------------|-----------|---------------|
| **Subscription** | Recurring flat fee (mo/yr) | Value is ongoing; usage is steady | Churn is now your whole business |
| **Usage-based** | Pay per unit consumed | Value scales with volume; usage varies a lot | Revenue is unpredictable; bills can surprise buyers |
| **Tiered** | Packaged bundles at set prices | Distinct buyer segments with distinct needs | Tier sprawl; unclear which tier fits whom |
| **One-time** | Single purchase | Value is delivered once; low ongoing cost to serve | No recurring revenue; constant new-sale pressure |
| **Freemium** | Free core, paid upgrade | Broad top-of-funnel + a clear, valued upgrade reason | Free users cost money; weak upgrade path = no revenue |

Most businesses layer models eventually (e.g. subscription + usage overage). Start with one.

## Good-better-best tiering framework

Three tiers, designed deliberately:

| Tier | Role | Who it's for | Design intent |
|------|------|-------------|---------------|
| **Good** | Entry / anchor-low | Price-sensitive, smaller need | Makes "Better" feel reasonable; not the one to push |
| **Better** | The CORE | Most of [ICP] | The default. Best value-for-money on purpose. |
| **Best** | Anchor-high / expansion | Power users, willing to pay more | Raises the perceived ceiling; captures high-WTP buyers |
...
## Setting the price test's pass/fail bar
