# Co-founder & Equity Split (reference)

Frameworks behind the `cofounder-and-equity` skill. Theme-agnostic; the founder supplies the people.

> **Equity, vesting, and legal/tax specifics vary by jurisdiction and need a qualified lawyer.**
> This is a thinking tool, not legal, tax, or financial advice. Agree the *principles* here, then
...
**Why and what**
- Why are we building this? What does "winning" look like to each of us (lifestyle, big exit, mission)?
- What's our time horizon, and what would make each of us quit?

**Roles & decision rights**
- Who owns which domain? What are our titles?
- Who is the final decision-maker (the company needs one)? What decisions require BOTH of us?
- How do we break a deadlock?

**Time & commitment**
- Full-time? From when? Any other jobs, studies, or side projects?
...
- What happens if someone wants to leave? Is fired? Burns out? Stops pulling weight?
- What happens to their equity if they go (this is what vesting answers)?
- What if we get an acquisition offer and disagree? What if one of us wants to raise and the other doesn't?
- What if our visions diverge in two years?
...
| Domain | Owner (final call) | Requires both? |
|--------|-------------------|----------------|
| Product & roadmap | | |
| Engineering / build | | |
| Sales & customers | | |
...
| Finance & fundraising | | |
| Hiring & firing | | |
| Spending above [threshold] | | (usually yes) |
| Equity / cap-table changes | | (always both) |
| Selling / shutting the company | | (always both) |

One named final decision-maker per domain; a short list of "both must agree" items for the big, irreversible calls.

## Conflict scenarios to pre-agree

Talk through these *before* they happen, while you're calm:
- A co-founder wants to leave, or quietly checks out and underperforms.
- You disagree on whether to take an acquisition offer.
- You disagree on raising money or on a major pivot.
- One co-founder puts in much more (or less) than expected.
- A serious values clash emerges (ethics, a key hire, how to treat the team).
- Personal-life changes (health, family, relocation) cut someone's availability.

For each: what's the process, who decides, and what happens to equity/role?
