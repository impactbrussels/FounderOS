...
└────────────────────────────────────────────────────────────────────┘
  ...
  Cross-cutting (run any time): start-here · founderos-prompt-scaffold · capture-learning
```

## The 7 operating principles

1. **Research before asserting.** Verify checkable claims or label them assumptions. Never invent market or legal numbers.
2. **A draft is not a decision.** Output is a starting point; name what still needs your human judgement.
