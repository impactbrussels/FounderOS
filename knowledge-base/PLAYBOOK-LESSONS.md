...
> - **So next time:** <changed behaviour>
> ```
...
_No lessons captured yet. Run `scope-mvp`, then `capture-learning` after your first experiment._
...
- **So next time:** When adding a skill, put the prompt in the skill body and let `prompts/` index it.
