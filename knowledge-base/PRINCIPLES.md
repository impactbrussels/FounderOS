...
- **The graveyard is full of well-built wrong things.** Most startups die from building
  something nobody wanted, not from building it badly. Validate the problem before the solution. *(seed)*
- **Speed of learning is the only durable advantage.** A first-time founder can't out-resource
  incumbents; they can out-learn them. Optimise every week for "what did we learn?" *(seed)*
